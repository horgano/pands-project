...
plt.title('1.Sepal Length (cm)', loc = 'left')
...
plt.title('2.Sepal Width (cm)', loc = 'left')
...
plt.title('3.Petal Length (cm)', loc = 'left')
...
plt.title('4.Petal Width (cm)', loc = 'left')
