...
sepal_width_mean_full = titled_df["Sepal Width(cm)"].mean()
print (f'Overall Sepal mean: {round(sepal_width_mean_full,2)}')
...
with open(FILENAME, 'w') as f:
    ...
    f.write(f'\nOverall Sepal width mean is: {sepal_width_mean_full}\n')
    f.write(f'\nOverall Petal length mean is: {petal_length_mean_full}\n')
    f.write(f'\nOverall Petal width mean is: {petal_width_mean_full}\n')
